...
namespace AnkurPrathisthan
{
    public class clsLibrarianManagement
    {
        ...
        public DataSet HandleLibrarians(int cmd, string FirstName, string LastName,string EmailID, string Address, string MobileNo, string AltMobileNo,string ClusterID,string AdminEmailID, string LibrarianID="",string ImagePath="")
        {
            DataSet ds = new DataSet();
            try
            {
        ...
        public sealed class SqlHelper
        {
            public static string ConnectionString(Int16 Type)
            {
                ...
                switch (Type)
                {
                    case 1:
                        {
                            StrCon = ConfigurationManager.ConnectionStrings["ankurmobile"].ToString();
                        }
                        break;
                }
            ...
            /// </summary>
            /// <param name="command">The SqlCommand totebe prepared</param>
